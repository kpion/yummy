...
(function (window) {
    ...
    class LightDom extends Array{
        ...
        // Find all the nodes CHILDREN (and subchildren etc.) of the current ones, matched by a selector
        find (parameter) {
        ...
        // Get the first element matching the selector, by testing the 
        // element itself and going up through its ancestors
        closest (parameter) {
            let result = new LightDom();
            this.forEach(node => {
                // Do we match ourselves?
